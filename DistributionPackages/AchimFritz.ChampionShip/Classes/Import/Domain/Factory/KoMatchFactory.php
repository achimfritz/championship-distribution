...
use AchimFritz\ChampionShip\Import\Domain\Model\GeneralMatch;
...
class KoMatchFactory
{
    ...
    /**
     * @param \AchimFritz\ChampionShip\Import\Domain\Model\GeneralMatch $match
     ...
     */
    public function createFromKoMatch(GeneralMatch $match, Cup $cup, KoRound $koRound)
    {
     ...
     */
    protected function createCrossGroupMatch(GeneralMatch $match, Cup $cup)
    {
     ...
     * @return CrossGroupMatch
     */
    protected function createCrossGroupWithThirdsMatch(GeneralMatch $match, Cup $cup)
    {
        $guest = $match->getGuestTeam();
        if (strlen($guest) === 2) {
     ...
     */
    protected function createTeamsOfTwoMatchesMatch(GeneralMatch $importMatch, Cup $cup)
    {
     ...
     * @return KoMatch $koMatch
     */
    public function createFromMatch(GeneralMatch $match, array $teams, Cup $cup, KoRound $koRound)
    {
