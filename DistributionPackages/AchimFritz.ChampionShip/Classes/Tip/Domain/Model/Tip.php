...
class Tip
{
    ...
    /**
     * The match
     * @var \AchimFritz\ChampionShip\Competition\Domain\Model\GeneralMatch
     * @ORM\ManyToOne
     * @Flow\Validate(type="NotEmpty")
     */
     ...
     *
     * @return \AchimFritz\ChampionShip\Competition\Domain\Model\GeneralMatch The Points's match
     */
     ...
     *
     * @param \AchimFritz\ChampionShip\Competition\Domain\Model\GeneralMatch $abstractMatch The Points's match
     * @return void
     */
    public function setMatch(\AchimFritz\ChampionShip\Competition\Domain\Model\GeneralMatch $match)
    {
