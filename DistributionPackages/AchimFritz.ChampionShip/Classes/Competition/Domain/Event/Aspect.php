...
class Aspect
{
     ...
     * @return void
     * @Flow\Before("method(AchimFritz\ChampionShip\Competition\Domain\Repository\GeneralMatchRepository->update())")
     */
     ...
     * @param \Neos\Flow\Aop\JoinPointInterface $joinPoint
     * @return void
     * @Flow\AfterReturning("method(AchimFritz\ChampionShip\Competition\Domain\Repository\GeneralMatchRepository->add())")
     */
     ...
     * @param \Neos\Flow\Aop\JoinPointInterface $joinPoint
     * @return void
     * @Flow\AfterReturning("method(AchimFritz\ChampionShip\Competition\Domain\Repository\GeneralMatchRepository->remove())")
     */
